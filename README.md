...
**在安装和运行前，先扫出 AI Skill 里的危险命令、凭据泄露、提示词注入和可疑行为。**
...
**为什么值得看：**
- 🔍 专门扫 AI Skill / Agent Skill 风险
- ⚡ 轻量，适合本地检查和 CI 门禁
- 🧩 支持 JSON / SARIF，方便平台和审计流接入
...
> **如果你把 AI Skill 当成插件，那 SafeSkill 就是安装前的安全检查。**
...
如果你要发推、发群、发 Hacker News，可以直接这么讲：
